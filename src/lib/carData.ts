...
function mapDatabaseCarToInterface(dbCar: DatabaseCar): Car {
  return {
    ...
    listPrice: typeof dbCar.list_price === 'number' ? dbCar.list_price : parseFloat(dbCar.list_price),
    range: dbCar.range,
    monthlyLeaseRate: typeof dbCar.monthly_lease_rate === 'number' ? dbCar.monthly_lease_rate : parseFloat(dbCar.monthly_lease_rate),
    bikRate: typeof dbCar.bik_rate === 'number' ? dbCar.bik_rate : parseFloat(dbCar.bik_rate),
